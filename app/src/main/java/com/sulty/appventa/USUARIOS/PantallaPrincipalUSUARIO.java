...
import com.sulty.appventa.ADAPTER.MyAdapterUSUARIOS;
...
public class PantallaPrincipalUSUARIO extends AppCompatActivity {
    ...
    FloatingActionButton bt_cerrar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(PantallaPrincipalUSUARIO.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(PantallaPrincipalUSUARIO.this);
        ...
        adapter = new MyAdapterUSUARIOS(PantallaPrincipalUSUARIO.this, articuloList);
    ...
    private void irInicio() {
        startActivity(new Intent(PantallaPrincipalUSUARIO.this, InicioSesionUSUARIOS.class));
        finish();
    }
